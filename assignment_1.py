...
roa_theta_range,roa_theta_dot_range,roa_results=roa.build_roa_grid(params,model.dynamics,
                                                                   model.next_spoke_trigger,
                                                                   theta_bounds,timestep,
                                                                   number_of_bounds=25)
...
theta_dot_next=poincare.build_return_map(theta_dot_range,theta_post_reset,params,model.dynamics,
                                         model.next_spoke_trigger,timestep=timestep)
...
if fixed_point is not None:
    floquet_multiplier=poincare.estimate_floquet_multiplier(fixed_point,theta_post_reset,params,
                                                            model.dynamics,model.next_spoke_trigger,
                                                            timestep=timestep)
...
roa_fraction_by_gamma,floquet_by_gamma=poincare.run_stability_sweep("ground_inclination",gamma_values,params,
                                                                    model.dynamics,model.next_spoke_trigger,
                                                                    model.compute_theta_bounds,
                                                                    timestep=timestep)
...
roa_fraction_by_n_spokes,floquet_by_n_spokes=poincare.run_stability_sweep("number_spokes",n_spokes_values,
...
poincare.plot_sweep_results(gamma_values,roa_fraction_by_gamma,floquet_by_gamma,"gamma (rad)")
poincare.plot_sweep_results(n_spokes_values,roa_fraction_by_n_spokes,floquet_by_n_spokes,"number of spokes N")
